...
PRAYER_API_BASE_URL=https://example.com/prayer-times
```

`app/core/secrets.py` may also be used locally, but it must never be committed. Use `app/core/secrets.example.py` as the template.
